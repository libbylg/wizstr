...
struct str {
    ...
    template <typename T>
    using partition_result = std::array<T, 3>;
    ...
    static auto split_rawname_view(std::string_view s) -> partition_result<std::string_view>;
    static auto split_rawname(std::string_view s) -> partition_result<std::string>;
    //
