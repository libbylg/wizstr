...
public:
    ...
    public:
        ...
        auto operator() const -> std::optional<const value_type&> {
            if (itr_ == seq_.cend()) {
                return std::nullopt;
            }
    ...
    static auto title_fields(std::string_view s) -> std::string;
