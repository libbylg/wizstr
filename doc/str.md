...
<code>
    ...
    static auto take_view(std::string_view s, size_type begin_pos, size_type end_pos) -> std::string_view;
    static auto take_view(std::string_view s, range_type range) -> std::string_view;
    static auto take_view(std::string_view s, size_type pos, ssize_type shifter) -> std::string_view;
    ...
    static auto take(std::string_view s, size_type begin_pos, size_type end_pos) -> std::string;
    static auto take(std::string_view s, range_type range) -> std::string;
    static auto take(std::string_view s, size_type pos, ssize_type shifter) -> std::string;
    ...
    static auto take_inplace(std::string& s, size_type begin_pos, size_type end_pos) -> std::string&;
    static auto take_inplace(std::string& s, range_type range) -> std::string&;
    static auto take_inplace(std::string& s, size_type pos, ssize_type shifter) -> std::string&;
    ...
    /// @param offset 该参数是有符号整数，用于指定删除字符串的长度和方向。如果为负数，表示向左删，如果为正表示向右删。shifter 的绝对值表示期望提取的数据的长度。
    ...
    static auto drop(std::string_view s, size_type begin_pos, size_type end_pos) -> std::string;
    ...
    static auto drop_inplace(std::string& s, size_type begin_pos, size_type end_pos) -> std::string&;
