...
#    echo   "Generate README.en.md success: '${SELFDIR}/README.en.md' -> '${PROJECT_ROOT}/README.en.md'"
    ...
    #   FAQ.md
    echo    "Start generate docs/FAQ.html"
    rm -rf "${PROJECT_ROOT}/docs/FAQ.html"
    "${SELFDIR}/gendoc" "${SELFDIR}/FAQ.md" -r "${PROJECT_ROOT}" -o "${PROJECT_ROOT}/docs/FAQ.html"
    RESULT=$?
    if [[ ${RESULT} -ne 0 ]]; then
        error   "Generate FAQ.md failed: '${SELFDIR}/FAQ.md' -> '${PROJECT_ROOT}/docs/FAQ.html'"
        return  1
    fi
    echo   "Generate FAQ.md success: '${SELFDIR}/FAQ.md' -> '${PROJECT_ROOT}/docs/FAQ.html'"

    #   MANUAL.md
    echo    "Start generate docs/MANUAL.html"
    rm -rf "${PROJECT_ROOT}/docs/MANUAL.html"
    "${SELFDIR}/gendoc" "${SELFDIR}/MANUAL.md" -r "${PROJECT_ROOT}" -o "${PROJECT_ROOT}/docs/MANUAL.html"
    RESULT=$?
    if [[ ${RESULT} -ne 0 ]]; then
        error   "Generate MANUAL.md failed: '${SELFDIR}/MANUAL.md' -> '${PROJECT_ROOT}/docs/MANUAL.html'"
        return  1
    fi
    echo   "Generate MANUAL.md success: '${SELFDIR}/MANUAL.md' -> '${PROJECT_ROOT}/docs/MANUAL.html'"
